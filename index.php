...
<head>
    ...
    <!--end::Base Styles -->
    <link rel="shortcut icon" href="assets/demo/default/media/img/logo/Azmeel-lcon.png"/>
</head>
<!-- end::Head -->
<!-- end::Body -->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="dashboard-stat color-1">
                            <div class="dashboard-stat-content"><h4>30</h4> <span>Effective projects</span></div>
                            <div class="dashboard-stat-icon"><i class="flaticon-interface-6"></i></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="dashboard-stat color-4">
                            <div class="dashboard-stat-content"><h4>35</h4> <span>Completed Projects</span></div>
                            <div class="dashboard-stat-icon"><i class="flaticon-list"></i></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="dashboard-stat color-2">
                            <div class="dashboard-stat-content"><h4>65</h4> <span>Total projects</span></div>
